...
export const translations = {
  ...
  en: {
    ...
    teacherAssessmentForm: {
      ...
      expectedFormatLabel: "Expected Response Format for AI Grading",
      expectedFormatPlaceholder: "Describe the expected response or key elements for the AI to grade against.",
      expectedFormatDescription: "This is used to improve the accuracy of AI feedback.",
