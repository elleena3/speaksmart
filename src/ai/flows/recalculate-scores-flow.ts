...
4.점 (상): 주제에 대해 논의하기에 충분한 어휘를 구사함.
...
| :--- | :--- |
| [유창성 측면에서 잘한 점을 구체적인 예시를 들어 목록 형식(-)으로 칭찬해 주세요.] | [유창성을 저해하는 요소를 지적하고, 개선을 위한 실질적인 조언 1~2가지를 목록 형식(-)으로 제안해 주세요.] |

### 🎤 발음 및 억양 (Pronunciation & Intonation) - 📈 점수: [점수]/5점
| 👍 잘한 점 (Strengths) | 💡 개선점 (Areas for Improvement) |
| :--- | :--- |
| [전반적으로 발음이 명확했거나 특정 단어/억양이 좋았던 점을 목록 형식(-)으로 칭찬해 주세요.] | [부정확했던 발음의 예시('단어'의 발음이 '발음'으로 들렸습니다)를 제시하고, 개선 방법을 목록 형식(-)으로 제안해 주세요.] |
...
const recalculateScoresFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    const rubricScores: RubricScores = {
        ...
        interaction: 1, // Default for monologue
    };
