    ...
    const startConversation = async () => {
        ...
        try {
            ...
            recorder.onstop = () => {
                ...
                setUploadError(null);
                uploadConversationRecording(blob, 'openai-realtime')
                    .then(storedUrl => {
                        storedRecordingUrlRef.current = storedUrl;
                        setStoredRecordingUrl(storedUrl);
                        setUploadState('done');
                    })
                    .catch(err => {
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    {recordingUrl && (
                        <RecordingPlayback
                            url={recordingUrl}
                            fileName="openai-live-conversation.webm"
